    ...
    <div className="w-full bg-[#FAF8F0] py-12 md:py-20">
      <div className="max-w-[880px] mx-auto px-5 sm:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          <div className="p-6 rounded-[16px] bg-white border border-[#D9D5C8] shadow-xs space-y-2">
            <span className="font-mono text-[11px] uppercase tracking-[0.1em] text-[#C99528] font-bold block">
              RETURN WINDOW
            </span>
            <h2 className="font-serif text-[22px] font-semibold text-[#123C2D]">
              24-Hour Return Request
            </h2>
            <p className="font-sans text-[14px] text-[#2A2118]/80 leading-relaxed">
        ...
        <div className="space-y-10 font-sans text-[15px] sm:text-[16px] text-[#2A2118]/85 leading-[1.75]">
          ...
          <section className="space-y-3 pt-2">
            ...
            <div className="p-6 sm:p-8 rounded-[16px] bg-white border border-[#D9D5C8] space-y-2">
