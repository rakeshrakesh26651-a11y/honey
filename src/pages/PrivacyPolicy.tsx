      ...
      <div className="max-w-[880px] mx-auto px-5 sm:px-8">
        ...
        <div className="space-y-10 font-sans text-[15px] sm:text-[16px] text-[#242424]/85 leading-[1.75]">
          ...
          <section className="space-y-3">
            ...
            <p className="font-medium text-[#242424] pt-1">
          ...
          {/* Contact Box */}
          <div className="mt-12 p-6 sm:p-8 rounded-[16px] bg-[#FAF9F5] border border-[#D9D7D0] space-y-3">
            <h3 className="font-serif text-[20px] font-semibold text-[#242424]">
              Contact Us
            </h3>
            <p className="text-[#242424]/80">
