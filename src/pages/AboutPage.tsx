      ...
      <div className="w-full bg-[#F5F1E6] min-h-screen py-10 md:py-18">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
          ...
          <nav className="flex items-center gap-2 mb-8 text-[13px] font-mono text-[#607568]">
            ...
            <span>/</span>
            <span className="text-[#123C2D] font-semibold">OUR STORY</span>
          </nav>
          ...
          <div className="text-center max-w-[850px] mx-auto mb-16 md:mb-20 space-y-4">
            ...
            <AnimatedHeading
              ...
              as="h1"
              className="font-serif text-[38px] sm:text-[52px] md:text-[62px] font-semibold text-[#123C2D] leading-[1.05] tracking-[-0.02em]"
            />
            ...
            <motion.p
              ...
              className="font-sans text-[17px] sm:text-[20px] text-[#2A2118]/85 leading-[1.6]"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center mb-20">
            <div className="lg:col-span-6 space-y-6 text-[#2A2118]/90 font-sans text-[16px] sm:text-[17px] leading-[1.7]">
              <div className="inline-block px-3 py-1 rounded-full bg-[#123C2D]/10 text-[#123C2D] font-mono text-[11px] font-bold uppercase tracking-wider">
                {BRAND_CONFIG.heritage}
              </div>
              <h2 className="font-serif text-[30px] sm:text-[38px] font-semibold text-[#123C2D] leading-[1.15]">
            ...
            <div className="lg:col-span-6">
              <div className="relative rounded-[22px] overflow-hidden border border-[#D9D5C8] shadow-[0_16px_40px_rgba(18,60,45,0.08)]">
                <img
          ...
          <div className="bg-[#FAF8F0] border border-[#D9D5C8] rounded-[24px] p-8 sm:p-12 mb-20">
            <div className="text-center max-w-[600px] mx-auto mb-12 space-y-2">
              <span className="font-mono text-[11px] uppercase tracking-widest text-[#D6A83A] font-bold">
                TIME-HONORED STANDARDS
              </span>
              <h3 className="font-serif text-[28px] sm:text-[34px] font-semibold text-[#123C2D]">
                How We Protect the Harvest
              </h3>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-6 rounded-[16px] bg-[#F5F1E6]/70 border border-[#D9D5C8]/80 space-y-3">
                <span className="font-mono text-[16px] text-[#D6A83A] font-bold">01</span>
                <h4 className="font-serif text-[20px] font-semibold text-[#123C2D]">
                  Unheated & Unpasteurized
                </h4>
                <p className="font-sans text-[14px] text-[#2A2118]/80 leading-[1.6]">
              ...
              <div className="p-6 rounded-[16px] bg-[#F5F1E6]/70 border border-[#D9D5C8]/80 space-y-3">
                <span className="font-mono text-[16px] text-[#D6A83A] font-bold">02</span>
                <h4 className="font-serif text-[20px] font-semibold text-[#123C2D]">
              ...
              <div className="p-6 rounded-[16px] bg-[#F5F1E6]/70 border border-[#D9D5C8]/80 space-y-3">
                <span className="font-mono text-[16px] text-[#D6A83A] font-bold">03</span>
                <h4 className="font-serif text-[20px] font-semibold text-[#123C2D]">
          ...
          {/* CTA Banner */}
          <div className="text-center py-12 px-6 rounded-[22px] bg-[#08291F] text-[#FAF8F0] space-y-6">
            <h3 className="font-serif text-[28px] sm:text-[36px] font-semibold">
              Taste the heritage of the peaks.
            </h3>
            <p className="font-sans text-[16px] text-[#F5F1E6]/80 max-w-[500px] mx-auto">
