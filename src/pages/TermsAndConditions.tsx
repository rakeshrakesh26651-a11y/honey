    ...
    <div className="w-full bg-[#F4F1EA] py-12 md:py-20">
      <div className="max-w-[880px] mx-auto px-5 sm:px-8">
        ...
        <div className="space-y-10 font-sans text-[15px] sm:text-[16px] text-[#242424]/85 leading-[1.75]">
          <p className="text-[17px] sm:text-[18px] text-[#242424] leading-[1.6] font-normal">
          ...
          <section className="space-y-3 p-5 sm:p-6 rounded-[14px] bg-[#FAF9F5] border border-[#D9D7D0]">
            ...
            <div className="space-y-2">
              <p className="font-medium text-[#242424]">
                Return Period: <span className="text-[#C9892E] font-bold">Within 24 hours of delivery</span>
              </p>
              <p>
          ...
          <section className="space-y-3 p-5 sm:p-6 rounded-[14px] bg-[#FAF9F5] border border-[#D9D7D0]">
            ...
            <div className="space-y-2">
              <p className="font-medium text-[#242424]">
                Refund Processing: <span className="text-[#C9892E] font-bold">Within 10 days</span> of acceptance of an eligible return.
              </p>
              <p>
          ...
          <section className="space-y-3">
            ...
            <div className="mt-4 p-6 rounded-[16px] bg-[#FAF9F5] border border-[#D9D7D0] space-y-2">
