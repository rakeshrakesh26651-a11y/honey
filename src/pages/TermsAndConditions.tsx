    ...
    <div className="w-full bg-[#f7f2e7] py-12 md:py-20">
      <div className="max-w-[880px] mx-auto px-5 sm:px-8">
        ...
        <div className="space-y-10 font-sans text-[15px] sm:text-[16px] text-[#1e1a16]/85 leading-[1.75]">
          ...
          {/* Section 7 */}
          <section className="space-y-3 p-5 sm:p-6 rounded-[14px] bg-white border border-[#657044]/20">
            <h2 className="font-serif text-[22px] sm:text-[24px] font-semibold text-[#1e1a16] leading-snug">
              7. Returns
            </h2>
            <div className="space-y-2">
              <p className="font-medium text-[#1e1a16]">
                Return Period: <span className="text-[#657044] font-bold">Within 24 hours of delivery</span>
              </p>
              <p>
          ...
          <section className="space-y-3 p-5 sm:p-6 rounded-[14px] bg-white border border-[#657044]/20">
            ...
            <div className="space-y-2">
              <p className="font-medium text-[#1e1a16]">
                Refund Processing: <span className="text-[#657044] font-bold">Within 10 days</span> of acceptance of an eligible return.
              </p>
              <p>
          ...
          <section className="space-y-3">
            ...
            <div className="mt-4 p-6 rounded-[16px] bg-white border border-[#1e1a16]/10 space-y-2">
