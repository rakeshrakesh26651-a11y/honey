...
export const WholesaleSection: React.FC = () => {
  return (
    <section id="wholesale" className="w-full py-16 lg:py-24 bg-[#242424] border-t border-[#242424]">
      <div className="max-w-[1200px] mx-auto px-6 md:px-10 text-center">
        ...
        >
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="font-mono text-[12px] uppercase tracking-[0.1em] text-[#DDAA55] font-semibold block leading-[18.2px]">
          ...
          <div className="pt-3">
            <button
              ...
              className="inline-flex items-center justify-center h-[50px] px-9 rounded-full bg-[#C9892E] hover:bg-[#DDAA55] text-[#242424] font-sans text-[15px] font-bold tracking-wider transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] shadow-md cursor-pointer"
            >
              WHOLESALE ENQUIRY
            </button>
          </div>
